...
unsigned xml_text_cpy(char *, int, const struct xml_text);

unsigned xml_text_cmp(const struct xml_text *, const struct xml_text *);

unsigned xml_text_cmp3(const struct xml_text *, const char *);

unsigned xml_text_cmp4(const struct xml_text *, const char *, unsigned);
...
int xml_node_walk(struct xml_element *, int (*)(struct xml_element *, int, void *), void *);

unsigned xml_text_cmp2(const struct xml_text, const struct xml_text);
...
char *xml_text_dup0(const char *, unsigned long);
...
struct xml_text xml_text_dup(const char *, unsigned long);
...
struct xml_text xml_text_escape2(const char *, unsigned, char *, int);

struct xml_text xml_node_text(struct xml_element *, char *, int);

struct xml_text xml_text_set(const char *, unsigned long);
